...
export default async function NewIncidentPage() {
  ...
  return <AppShell headerTitle="Tạo báo cáo sự cố" headerSubtitle="Nhập thủ công" unreadCount={unread}>
    <div className="mx-auto max-w-3xl space-y-4"><section><p className="text-[10px] font-bold uppercase tracking-[0.16em] text-teal-700">Incident Reporting</p><h1 className="clinical-page-title mt-1">Tạo báo cáo sự cố</h1><p className="mt-1 text-xs text-slate-600">Tạo thủ công. Không nhập tên, mã bệnh án hoặc thông tin nhận diện người bệnh.</p></section>
      <form action={submit} className="clinical-card grid gap-3 p-4 sm:grid-cols-2 sm:p-5">
